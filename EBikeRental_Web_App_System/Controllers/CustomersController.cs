...
namespace EBikeRental_Web_App_System.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,LastName,Phone,Email,Address,Dob,BikeRentalActive,PaymentId")] Customer customer)
        {
            ...
            ViewData["PaymentId"] = new SelectList(_context.Set<Payment>(), "PaymentId", "PaymentId", customer.PaymentId);
            return View(customer);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FirstName,LastName,Phone,Email,Address,Dob,BikeRentalActive,PaymentId")] Customer customer)
        {
